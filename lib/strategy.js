...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://atlas-sso.pmc.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://atlas-sso.pmc.com/oauth/token';
  options.scopeSeparator = options.scopeSeparator || ',';


  OAuth2Strategy.call(this, options, verify);
  this.name = 'sheknows';
  this._profileURL = options.profileURL || 'https://atlas-sso.pmc.com/api/me';
